                    ...
                    Expanded(
                      ...
                      child: Slider(
                        ...
                        onChanged: (double value) {
                          ...
                          log.i('TourSelectionScreen: Número de sitios seleccionado: ${numberOfSites.round()}');
                        },
                ...
                Center(
                  child: ToggleButtons(
                    ...
                    onPressed: (int index) {
                      ...
                      log.i('TourSelectionScreen: Modo de transporte seleccionado: $selectedMode');
                    },
                    children: [
                      Padding(
                  ...
                  child: Wrap(
                    ...
                    children: userPreferences.keys.map((String key) {
                      ...
                      return ChoiceChip(
                        ...
                        backgroundColor: isSelected ? preference['color'] : preference['color']!.withOpacity(0.1),
                        elevation: isSelected ? 4.0 : 1.0,
                        shadowColor: Colors.grey.shade300,
                        selected: isSelected,
                        onSelected: (bool selected) {
                          setState(() {
                            selectedPreferences[key] = selected; // Actualizamos el estado
                          });
                          log.i('TourSelectionScreen: Preferencia "$key" seleccionada: $selected');
                        },
                      );
                    }).toList(),
                  ),
                    ...
                    Expanded(
                      child: Slider(
                        ...
                        onChanged: (double value) {
                          ...
                          log.i('TourSelectionScreen: Tiempo máximo de ruta seleccionado: ${maxTimeInMinutes.round()} minutos');
                        },
                        activeColor: Theme.of(context).primaryColor,
                        inactiveColor: Theme.of(context).primaryColor.withOpacity(0.8),
                      ),
                ...
                MaterialButton(
                  ...
                  onPressed: () {
                    if (selectedPlace.isEmpty) {
                      ...
                      log.w('TourSelectionScreen: Lugar vacío, usando "Salamanca, España" por defecto.');
                    }

                    // Mostrar diálogo de carga
                    LoadingMessageHelper.showLoadingMessage(context);
                    log.i('TourSelectionScreen: Solicitando tour en $selectedPlace con $numberOfSites sitios.');
                    ...
                    BlocProvider.of<TourBloc>(context).stream.listen((tourState) {
                      ...
                      if (!tourState.isLoading && !tourState.hasError && tourState.ecoCityTour != null) {
