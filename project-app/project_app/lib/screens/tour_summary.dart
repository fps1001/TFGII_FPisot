        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(
                horizontal: 8,
                vertical:
                    8), // Ajustamos el padding para que use casi todo el ancho
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Distancia: ${tour.distance.toStringAsFixed(2)} km',
                        style: const TextStyle(fontSize: 16)),
                    const SizedBox(height: 4),
                    Text(
                        'Duración: ${tour.duration.floor()} minutos', // Eliminamos los decimales
                        style: const TextStyle(fontSize: 16)),
                    const SizedBox(height: 4),
                    ...
                    Row(
                      children: tour.userPreferences.map((preference) {
                        final iconData = userPreferences[preference]?['icon'];
                        final color = userPreferences[preference]?['color'] ??
                            Colors.black;
                        return Padding(
