...
\usepackage{float}
\renewcommand{\floatpagefraction}{.8} % Página con al menos 80% ocupada por tablas/figuras
\renewcommand{\textfraction}{.1}     % Permite 10% de texto en una página
\renewcommand{\topfraction}{.9}      % Parte superior puede ocupar hasta 90%
\renewcommand{\bottomfraction}{.9}   % Parte inferior puede ocupar hasta 90%
\setcounter{totalnumber}{5}          % Permite varias tablas/figuras por página
\setcounter{topnumber}{3}            % Máximo de 3 tablas arriba
\setcounter{bottomnumber}{3}         % Máximo de 3 tablas abajo
