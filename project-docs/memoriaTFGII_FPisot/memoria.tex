...
% Glosario
\newglossaryentry{ingenieria_prompt}{name={Ingeniería del prompt}, description={Proceso de optimización y diseño de instrucciones (prompts) para mejorar las respuestas de los modelos de lenguaje a gran escala (LLM)}}
